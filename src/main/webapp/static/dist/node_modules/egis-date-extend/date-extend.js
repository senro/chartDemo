define('node_modules/egis-date-extend/date-extend', function(require, exports, module) {
  ...
  var dateExtend = {
      ...
      getLastWeekStartDay: function () {
          //获得上周的开始日期
          var now = this.now();
          var getUpWeekStartDate = new Date(now.getFullYear(), now.getMonth(), now.getDate() - now.getDay() -6);
          return this.toString(getUpWeekStartDate);
      },
      getLastWeekEndDay: function () {
          //获得上周的结束日期
          var now = this.now();
          var getUpWeekEndDate = new Date(now.getFullYear(), now.getMonth(), now.getDate() + (6 - now.getDay() - 6));
          return this.toString(getUpWeekEndDate);
      },
      // 当前月
      ...
      /****获取上个月的当前时间 yyyy-mm-dd hh:ii:ss*****/
      getNextMonthDateTime: function() {
          var now = this.now();
          var prevMonthToday = new Date(now.getFullYear(), now.getMonth() + 1, now.getDate() );
          return this.toString(prevMonthToday) + ' ' + this.toString(now, 'hh:ii:ss');
      },
      /****获取下一年的当前时间 yyyy-mm-dd hh:ii:ss*****/
      getNextYearDateTime: function() {
          var now = this.now();
          var prevMonthToday = new Date(now.getFullYear()+1, now.getMonth() , now.getDate() );
          return this.toString(prevMonthToday) + ' ' + this.toString(now, 'hh:ii:ss');
      },
      ...
      normalizeSingleNum:function (num) {
      ...
      normalizeToSingleNum:function (num) {
