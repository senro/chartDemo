define('node_modules/egis-tab/tab', function(require, exports, module) {

  
  var $ = require('node_modules/egis-tab/node_modules/egis-jquery/jquery');
  var parseArgus = require('node_modules/egis-parse-argus/parse-argus');
  
  module.exports = function ($_btns, $_conts, str_btn_hover, str_trigerType, str_transType, int_currIndex,fun_callback) {
      /*
       * @位置：  常用组件；
       * @名字：  sliderTab；
      ...
      fun_callback&&fun_callback(currIndex);
      ...
      function transNormal(index) {
          ...
          fun_callback&&fun_callback(index);
          return false;
      }
