define('components/utils/ajax.jsx', function(require, exports, module) {
  ...
  */
  ...
  var fetch = require('node_modules/fetch-ie8/fetch');
  				...
  				var fetchResult = fetch(url + (method == "get" ? "?" + data : ""), {
  								...
  								if (String(json.status) === successCode) {
  												...
  												if (typeof faillCallback === "function") {
  																...
  																(0, _elementUi.Message)(json.detail || json.message || json.msg || "请求失败！");
  												}
  ...
  //# sourceMappingURL=/chartDemo/static/dist/components/utils/ajax.js.map
