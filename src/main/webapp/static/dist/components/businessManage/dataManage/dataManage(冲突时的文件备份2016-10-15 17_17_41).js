define('components/businessManage/dataManage/dataManage(冲突时的文件备份2016-10-15 17_17_41)', function(require, exports, module) {
  ...
  function render(){
      ...
      $('.page-dataManage').on('click','.btn-updateData',function(){
          $addDataModal.modal('show');
      ...
      $('#fileupload').change(function(){
          if(/\.xsl|\.xlsx/.test($('#fileupload').val())){
      ...
      $('#fileupload').fileupload({
          ...
          dataType: 'json',
              ...
              if(data.status==1){
                  ...
                  //$('input[name=systemLogoUrl]').val(data.data.logoUrl);
                  model_Data.dataUrl=data.data.match(/([^\/])*[\.xls|\.xlsx]$/g)[0];
              }else{
